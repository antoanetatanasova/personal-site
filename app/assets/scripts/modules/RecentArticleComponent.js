...
const RecentArticleComponent = () => {
    return (
        <article className="recent-article">
                <h4 className="recent-article-section-title">Recent Publication</h4>
            <div className="recent-article-wrapper">
                <h2 className="recent-article-main-title">Military Reforms as a Diplomatic Bargaining Chip</h2>
