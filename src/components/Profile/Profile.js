...
const Profile = () => {
    return (
        <section className={style.profile}>
            <img className={style.profilePicture} src="https://res.cloudinary.com/the-potential/image/upload/v1615903169/personal-site/antoinette_ezrg3f.jpg" alt="Profile"></img>
